...
const LeftImgBoxComponent = ({featureImg, icon, title, subtitle, link, baseUrl, textLink, iconName}:Props) => {
  return (
    <div className='flex flex-col lg:flex-row my-8'>
        ...
        <div className='flex flex-col w-auto lg:w-1/2 lg:p-6 items-start'>
...
export default LeftImgBoxComponent